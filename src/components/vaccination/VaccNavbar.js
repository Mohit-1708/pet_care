...
export default function Navbar() {
  ...
  return (
    <header className="shadow-md">
      ...
      <div className="flex items-center px-4 sm:px-6 md:px-8 py-4 bg-white relative">
        ...
        <nav className="hidden md:flex gap-8 text-gray-700 font-bold absolute left-1/2 -translate-x-1/2">
