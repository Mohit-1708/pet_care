...
export default function ServicesSection() {
  ...
  {/* Third mobile line (rest of the content) */}
  <span className="text-[#5C372D]"> Experts</span>
  <span className="text-[#DD7542]"> Who Truly</span>

  {/* Desktop-only break before "Care" */}
  <br className="hidden md:block" />

  <span className="text-[#DD7542]"> Care</span>
</h1>
  ...
  <img
    src={teamPhoto}
    alt="Doctor"
    className="w-full md:w-[80%] h-60 sm:h-80 md:h-[450px] object-cover  mx-auto"
  />
</div>
